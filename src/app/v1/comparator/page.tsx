...

                    {
                        ...
                        <div className="flex flex-col items-center md:flex-row gap-8 mt-10">
                            <div className="flex flex-col gap-6">
                                <img
                                    src={product.image}
                                    className="rounded-lg h-[300px] w-[300px] md:h-[250px] md:w-[242px] lg:h-[440px] lg:w-[440px] xl:h-[490px] xl:w-[490px] object-fill"
                                    alt={product.name}
                            ...
                            <div className="flex flex-col gap-4">
                                <p className={`${quicksand.className} text-center md:text-start text-lg md:text-xl lg:text-2xl text-[#646464]`}>{product.name}</p>
